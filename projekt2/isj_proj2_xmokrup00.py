...
def solfege(title_hymn):
    ...
    hymn_list = hymn.split()          #rozdeli velkej string                                     # vase reseni
    
    # skipping always two strings kazdy treti, and ending 3 strings from the end
    skip2 = hymn_list[:-3:3]  # [start:end:step]                                                 # vase reseni

    # the skip2 list as a string, ', ' as a separator
    skip2_str = ', '.join(skip2)     #list stringu spoji ', ' do velkeho stringu                                          # vase reseni
